...
REM Docbook文件的路径
@set DocBookFilePath=%BasePath%\doc\docbook\ta_doc.xml
REM Docbook所在的目录路径
@set DocBookPath=%BasePath%\doc\docbook
REM 目标目录
@set TargetPath=%BasePath%\doc\docbook\target
@set TargetFile=%TargetPath%\TaDoc.chm
@set TmpPath=%BasePath%\tmp\TaDoc\chm\
...
@set DocBookPath=%BasePath%\doc\docbook
@set TargetPath=%BasePath%\doc\docbook\target
@set TargetFile=%TargetPath%\TaDoc.pdf
@set TmpPath=%BasePath%\tmp\TaDoc\pdf\
...
explorer /e,%BasePath%doc\docbook\target\
